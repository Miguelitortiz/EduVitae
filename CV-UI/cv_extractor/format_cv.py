...
if __name__ == "__main__":
    ...
    output_dir = os.path.abspath(os.path.join(script_dir, "..", "..", "EduVitae", "src", "content", "profesores"))
    
    # Fallback si EduVitae no existe como hermano
    if not os.path.exists(output_dir):
        output_dir = os.path.abspath(os.path.join(script_dir, "..", "src", "content", "profesores"))
